...
public class Forelesning {
    ...
    public boolean equals(Object o) {
        ...
        if (klStart != null ? !klStart.equals(that.klStart) : that.klStart != null) return false;
        if (klSlutt != null ? !klSlutt.equals(that.klSlutt) : that.klSlutt != null) return false;
        if (fag != null ? !fag.equals(that.fag) : that.fag != null) return false;
        if (foreleser != null ? !foreleser.equals(that.foreleser) : that.foreleser != null) return false;
        if (bra != null ? !bra.equals(that.bra) : that.bra != null) return false;
        if (middels != null ? !middels.equals(that.middels) : that.middels != null) return false;
        if (daarlig != null ? !daarlig.equals(that.daarlig) : that.daarlig != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (klStart != null ? klStart.hashCode() : 0);
        result = 31 * result + (klSlutt != null ? klSlutt.hashCode() : 0);
        result = 31 * result + (fag != null ? fag.hashCode() : 0);
        result = 31 * result + (foreleser != null ? foreleser.hashCode() : 0);
        result = 31 * result + (bra != null ? bra.hashCode() : 0);
        result = 31 * result + (middels != null ? middels.hashCode() : 0);
        result = 31 * result + (daarlig != null ? daarlig.hashCode() : 0);
        return result;
    }
